...
export default function Home() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://127.0.0.1:3000/signin", {
                username,
                password
            })
            if (res.status === 200) {
        ...
        <>
            <div className="flex flex-col self-center h-full w-full justify-center items-center gap-5">
                <div className="tabs ">
                    ...
                    <Link href="/auth/signup" className="tab tab-bordered  tab-lg">Sign up</Link>
                </div>
                ...
                <div className="w-full p-6  md:max-w-md">
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            <button className="btn btn-block bg-primary" onClick={handleSubmit}>Login</button>
                        </div>
                    </form>
                </div>
            </div>
