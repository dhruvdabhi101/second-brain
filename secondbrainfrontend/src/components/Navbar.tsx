            ...
            <div className="flex flex-col w-3/4  rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
                ...
                <div className="navbar bg-base-100  rounded-2xl">
                    <div className="navbar-start">
                        ...
                        <a className="btn btn-ghost normal-case text-xl">Second Brain</a>
                    </div>
                    <div className="navbar-center hidden lg:flex">
                        <ul className="menu menu-horizontal px-1">
                            <li> <Link href={"/dashboard/projects"}>Project</Link></li>
                            <li> <Link href={"/dashboard/area"}>Area</Link></li>
                            <li> <Link href={"/dashboard/resources"}>Resources</Link></li>
                            <li> <Link href={"/dashboard/archives"}>Archives</Link></li>
                        </ul>
